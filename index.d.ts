...
declare global
{
    ...
    type Ui<TEntity extends AnyEntity> = {
    ...
    type Tab<TEntity extends AnyEntity> = {
        sections: {
    ...
    type Section<TEntity extends AnyEntity> = {
        controls: Control[];
        getLabel: () => string;
        getName: () => string;
    ...
    type LookupAttribute = Override<AnyAttribute, {
        getValue: () => { id: string; }[];
        setValue: (value: {
            entityType: string,
            id: string,
    ...
    type StringAttribute = Override<AnyAttribute, {
        getValue: () => string;
        setValue: (value: string) => void;
    }>;

    type NumberAttribute = Override<AnyAttribute, {
        getValue: () => number;
        setValue: (value: number) => void;
    }>;

    type BooleanAttribute = Override<AnyAttribute, {
        getValue: () => boolean;
        setValue: (value: boolean) => void;
    }>;

    type DateAttribute = Override<AnyAttribute, {
        getValue: () => Date;
        setValue: (value: Date) => void;
    }>;

    type OptionSetAttribute = Override<AnyAttribute, {
        getValue: () => number;
        setValue: (value: number) => void;
        getOption: () => Option;
        getOptions: () => Option[];
